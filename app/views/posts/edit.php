		...
		<div class="card_body">
			...
			<form action="<?php echo URLROOT ?>/posts/edit/<?php echo $data['id']; ?>" method="POST">
				...
				<div class="form-group <?php echo (!empty($data['title_err']) ? 'is-invalid' : '') ?>">
					...
					>
					<span class="invalid-feedback"><small class="text-danger"><?php echo !empty($data['title_err']) ? $data['title_err']  : '';?></small></span>
				</div>
				...
				<div class="form-group <?php echo (!empty($data['body_err']) ? 'is-invalid' : '') ?>">
					...
					<span class="invalid-feedback"><small class="text-danger"><?php echo !empty($data['body_err']) ? $data['body_err'] : '' ; ?></small></span>
				</div>
